...
import { Sparkles, Plus, Pencil, Trash2, Loader2, Bot, Award, FileQuestion, CheckCircle2, Type, Minus, Settings, Save, Clock, Eye, RotateCcw, Sparkles as SparklesIcon, Share2, Copy, Check } from 'lucide-react';
...
export const EditQuizPage: React.FC = () => {
  ...
  const getShareUrl = () => {
    ...
    return `${window.location.origin}${APP_ROUTES.PUBLIC_QUIZ(quiz.share_code)}`;
  };
          ...
          <div className="space-y-4 mt-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                <code className="text-sm bg-gray-50 px-3 py-2 rounded border flex-1 font-mono text-gray-800 break-all">
                  {getShareUrl()}
                </code>
                <Button
              ...
              <p className="text-xs text-gray-500 mt-2">
                Share this link with others to let them take your quiz
              </p>
            </div>
